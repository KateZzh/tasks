...
const str14: string = "HeLlo world!".toLowerCase().trim();
let obj14 = {};
...
const arr14: number[] = Object.values(obj14);
const maxArr14: number = Math.max(...arr14);

for (let key in obj14) {
  if (obj14[key] === maxArr14) console.log(`символ: ${key}, количество: ${obj14[key]}`);
}
