...
const arrNum16: number[] = [3, 5, 8, 15, 35];
let temp: number[] = [arrNum16[0]];
...
if (temp.length === arrNum16.length) console.log(`массив ${temp} является строго возрастающей последовательностью`);
